...
- **D-19:** **Seed all 3 pools, full-range LP, 0.30% (3000) fee tier uniform,** modest depth ~5k USDC-equivalent each. Full-range avoids any out-of-range swap revert mid-demo. 0.30% matches the Phase 0 test signal (`fee: 3000`).
